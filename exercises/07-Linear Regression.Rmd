...
Use the `ChickWeight` data set to create a linear regression model which predicts the weight, with up to 10 variables.

Examine the model's $R^2$ and compare with your collegues. Examine the model's residuals in a residual plot and a qqplot.