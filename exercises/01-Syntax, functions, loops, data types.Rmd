...
a <- 1
b <- 2
d = 3 # just to show that this works
...
In the previous exercise we used variable names `a`, `b`, `d`, `e`. We skipped `c`. Why is that? Type `?c` in the console and see the documentation.
