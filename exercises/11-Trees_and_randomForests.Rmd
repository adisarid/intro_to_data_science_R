...
What prunning does for a specific complexity parameter $\alpha$ is to find the tree which minimizes:
...
# q1
telco_churn <- read_csv("https://github.com/adisarid/intro_to_data_science_R/raw/master/datasets/WA_Fn-UseC_-Telco-Customer-Churn.csv") %>%
  select(-customerID)
